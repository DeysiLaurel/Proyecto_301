...
### Proyecto Principal
**URL:** [https://www.figma.com/design/W1ckLCY1GWmAAZDX7N0laa/Sistema-de-venta-Saz%C3%B3n-Peruana?node-id=0-1&t=f6uxnnJMZywuNy6g-1]
---
...
**Paleta de colores:**
- **Color primario:** #D97706 - Acciones principales
- **Color secundario:** #F59E0B - Elementos complementarios
- **Color de texto:** #374151 - Textos
- **Colores de estado:**
  - Éxito: #22C55E
  - Error: #DC2626
  - Advertencia: #F59E0B
...
**Tipografía:**
- **Principal:** [Quicksand-12] - Textos y contenido
- **Títulos:** [Quicksand-14] - Encabezados


**Espaciado:**
- Sistema de **25px,50px grid**
- Espaciado base: 25px(mobile),50px(desktop)
...
### Flujo Principal
1. **Login**
![alt text](<Login (1).svg>)

2. **Página de bienvenida**
![alt text](<Menu (1).svg>)

3. **Catalogo comida**
![alt text](<Comida Marina.png>)

4. **Agregar Comida**
![alt text](<Comida Marina 1.png>)
   
5. **Carrito de compra**
![alt text](<Mi Carrito (1).svg>)
...
**Responsable de diseño:** [Deysi Laurel]  
**Canal de comunicación:** [Discord, google meet.]  
**Horario de disponibilidad:** [14:00 - 20:00]
